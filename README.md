...
В данной лабораторной работе выполнено освоение работы с LINQ-запросами в C# для выполнения сложных операций с данными, представленными в виде Excel-таблиц. Реализована система управления банковскими инвестиционными счетами с поддержкой многовалютных операций, конвертацией по курсам и выполнением аналитических запросов.
